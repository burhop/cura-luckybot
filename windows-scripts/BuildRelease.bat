...
copy /y  "..\cura5.x\share\resources\variants\creality_ender3pro_luckybot0.84.inst.cfg" Ender3LuckyBotProfiles
"C:\program files\7-Zip\7z.exe" a Ender3LuckyBotProfilesVer0.4.zip Ender3LuckyBotProfiles\
pause
